...
public enum DriverType {
	...
	public static DriverType valueOf( Class<? extends WebDriver> clazz ) {
		for ( DriverType driverType: DriverType.values() ) {
			//Need to check for null here--the value sent in could be a driver type we haven't implemented yet
			if ( driverType.driverClass != null && driverType.driverClass.isAssignableFrom( clazz ) ) {
				return driverType;
			}
		}
		return Other;
