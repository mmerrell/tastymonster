...
import com.tastymonster.patentmojo.automation.element.base.ButtonWebElement;
import com.tastymonster.patentmojo.automation.element.base.DivWebElement;
import com.tastymonster.patentmojo.automation.element.base.LinkWebElement;
import com.tastymonster.patentmojo.automation.element.base.PlaceholderWebElement;
import com.tastymonster.patentmojo.automation.element.base.TableWebElement;
import com.tastymonster.patentmojo.automation.element.base.TextBoxWebElement;
...
public class ParseVelocity implements IPresentationParser {
	...
	public Set<FieldDetails> buildFieldDetails() {
		...
		for ( String line: StringUtils.split( pageContents, System.lineSeparator() ) ) {
			Matcher m = parseOneLine( line );
			if ( m.matches() ) {
				...
				fields.add( new FieldDetails( fieldAttributes.get( "id" ), elementDetails.getType(), macroName ) );
			}
		}
	...
	private List<String> scrubParams( List<String> paramList ) {
		...
		for ( String string: paramList ) {
			scrubbedList.add( string.replaceAll( "[^\\w]", "" ) );
		}
		return scrubbedList;
	}
