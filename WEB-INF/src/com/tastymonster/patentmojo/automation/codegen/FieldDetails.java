...
public class FieldDetails implements Comparable<FieldDetails> {
	...
	FieldDetails( String id, Class<? extends AbstractWebElement> type, String macroName ) {
		this.setId( id );
		this.setType( type );
		this.setMacroName( macroName );
	}
	
	FieldDetails( String id, Class<? extends AbstractWebElement> type, String macroName, String pageName ) {
		this.setId( id );
		this.setType( type );
		this.setMacroName( macroName );
