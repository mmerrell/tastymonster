...
/**
 * Each PageInfo object represents a single "page", as defined by the caller. If
 * a page represents more than one template, it will be a combination of these
 * PageInfo objects meshed together
 * 
 * @author Marcus
 * 
 */
public class PageInfo {
    ...
    public String getPageFieldPackage() {
        return "com.tastymonster.automation.director.user";
    }
    ...
    /**
     * The file will be parsed according to its implementation. It will call
     * parseVelocity, parseJSP, or whatever type (plug-in) is appropriate
     * 
     * @param file
     * @return
     */
    public void initPage(File file) {
        ...
        // The factory will return an IPresentationParser with the correct
        // implementation
