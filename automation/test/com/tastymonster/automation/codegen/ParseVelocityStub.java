...
public class ParseVelocityStub implements IPresentationParser {
	...
	public ParseVelocityStub( File file ) {
		this.file = file;
	}
	...
	protected static Map<String, WebElementDetails> macroNameToWebElement = new HashMap<String, WebElementDetails>();
